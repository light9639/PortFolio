                ...
                <React.Fragment>
                    {
                        list.map(function (item: IntroduceType, idx: number) {
                            return (
                                <div className="introduce_Wrapper w-full sm:w-1/1 md:w-1/2 flex flex-col p-5" key={idx} data-aos="fade-up" data-aos-duration={idx % 2 == 0 ? "1000" : "1150"} data-aos-easing="ease-in-out" data-aos-once="true">
