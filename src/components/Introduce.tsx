...
import { IntroduceType } from "../Type/TypeBox";
                            ...
                            <div className="introduce_MainBox">
                                ...
                                <div className="p-4 flex-1 flex flex-col">
                                    ...
                                    <div className="border-t border-grey-light pt-5 mb-4 text-grey-darker text-base flex-1">
                                        <p><span className="introduce_text">기간/인원 :</span> <span className="text_gradient">{item.time}</span> / <span className="font-medium">1인 개발</span> </p>
                                    </div>
                                    <a
                                        href={item.href1}
                                ...
                                <div className="pr-4 py-4 border-t border-grey-light">
                                    ...
                                    <span className="introduce_smallBox mr-2"># {item.use1}</span>
                                    <span className="introduce_smallBox mr-2"># {item.use2}</span>
                                    <span className="introduce_smallBox"># {item.use3}</span>
                                </div>
                            </div>
                        </div>
                    );
