...
function DarkModeToggle() {
    const clickEvent = document.getElementById('toggleDarkMode');
    var count = 0;
    ...
    return (
        <>
            <button id="toggleDarkMode" className="rounded-lg z-10 hover:bg-slate-100 dark:hover:bg-slate-800 transition-all duration-150">
                {/* Light */}
