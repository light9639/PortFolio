    ...
    return (
        <section className="text-gray-700 body-font">
            <div className="container mx-auto flex px-5 py-14 md:py-28 flex-col lg:flex-row items-center">
                <div className="flex flex-col mb-16 items-center text-center lg:w-1/2 lg:pr-16 lg:items-start lg:text-left lg:mb-0 lg:flex-grow" data-aos="fade" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-once="false">
                    ...
                    <p className="mb-7 leading-relaxed text-base mt-3" data-aos="fade" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-once="false">저는 웹 프론트엔드 개발분야에 <br className='block sm:hidden' />취업을 준비중인 이동호 입니다.
                ...
                <div className="w-5/6 lg:w-full lg:max-w-lg" data-aos="fade" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-once="false">
                    <MainAnimation />
                </div>
            </div>
        </section>
