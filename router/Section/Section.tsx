            ...
            <div className="container mx-auto flex px-5 py-14 md:py-28 flex-col lg:flex-row items-center">
                <div className="flex flex-col mb-16 items-center text-center lg:w-1/2 lg:pr-16 lg:items-start lg:text-left lg:mb-0 lg:flex-grow">
                    ...
                    <div className="flex justify-center">
                        <Link to="/About" className="Blue_box WebKit inline-flex py-2 px-5 leading-8 focus:outline-none border-none hover:opacity-75 transition mr-3 line-clamp-1">
                            About Me
                        </Link>
                        <Link to="/Site" className="Blue_box WebKit inline-flex py-2 px-5 leading-8 focus:outline-none border-none hover:opacity-75 transition mr-3">
                            My Site Page
                        </Link>
